...
void countApplesAndOranges(int s, int t, int a, int b, vector<int> apples, vector<int> oranges) {
    std::cout << std::count_if(apples.begin(), apples.end(), [&](int d){ return a+d >= s && a+d <= t; }) << std::endl;
    std::cout << std::count_if(oranges.begin(), oranges.end(), [&](int d){ return b+d >= s && b+d <= t; }) << std::endl;
}
// --------------------------------------------------------- // 
